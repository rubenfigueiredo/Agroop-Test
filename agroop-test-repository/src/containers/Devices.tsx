...
const Devices: React.SFC<Area> = () => {
  ...
  // normalmente costumo por isto inline com o resto do jsx
  return (
    <div className={styles.card_container}>
      <span className={styles.card_container__title}>Areas</span>
      <div className={styles.card_container__add} />
              ...
              <Link to={`/device/` + area.device}>
                <div className={styles.card__body}>
                  <div className={styles.card__panel}>
                    ...
                    <div className={styles.card__intro}>{area.crop}</div>
                  </div>
                  <div
                    className={`${styles.card__right_panel} ${
                      styles.card__panel
                    }`}
                  >
                    <p>{area.device}</p>
